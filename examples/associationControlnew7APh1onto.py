...
# METODO DE MOVIMIENTO 1 - para mover un dispositivo de un punto a otro con el metodo net.startMobility
    ...
    net.startMobility( time=30, repetitions=1, ac_method='ssf')
    net.mobility( sta1, 'start', time=31, position= u1_start)
    net.mobility( sta1, 'stop', time=69, position= u1_stop)
...
#ap1.cmd('dpctl unix:/tmp/ap1 flow-mod table=0,cmd=add in_port=3 meter:2 apply:output=flood')
    ...
    #sleep(1)
    #makeTerm( sta1, cmd="bash -c 'iperf -c 10.0.0.4 -u -b 2M -t 85 -p 5566;'" )
